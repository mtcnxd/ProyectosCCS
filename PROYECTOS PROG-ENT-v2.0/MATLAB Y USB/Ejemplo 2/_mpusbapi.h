...
DWORD __stdcall MPUSBGetDLLVersion(void);
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBGetDeviceCount(PCHAR pVID_PID);
...
//
extern "C" __declspec(dllexport)
HANDLE __stdcall MPUSBOpen(DWORD instance,    // Input
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBRead(HANDLE handle,              // Input
                PVOID pData,                // Output
                DWORD dwLen,                // Input
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBWrite(HANDLE handle,             // Input
                 PVOID pData,               // Input
                 DWORD dwLen,               // Input
                 PDWORD pLength,            // Output
                 DWORD dwMilliseconds);     // Input
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBReadInt(HANDLE handle,           // Input
                   PVOID pData,             // Output
                   DWORD dwLen,             // Input
                   PDWORD pLength,          // Output
                   DWORD dwMilliseconds);   // Input
...
//
extern "C" __declspec(dllexport)
BOOL __stdcall MPUSBClose(HANDLE handle);
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBGetDeviceDescriptor(HANDLE handle,       // Input
...
//      
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBGetConfigurationDescriptor(HANDLE handle,       // Input
                               UCHAR bIndex,        // Input
                               PVOID pDevDsc,       // Output
                               DWORD dwLen,         // Input
                               PDWORD pLength);     // Output
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBGetStringDescriptor(HANDLE handle,       // Input
                               UCHAR bIndex,        // Input
...
//
extern "C" __declspec(dllexport)
DWORD __stdcall MPUSBSetConfiguration(HANDLE handle,         // Input
